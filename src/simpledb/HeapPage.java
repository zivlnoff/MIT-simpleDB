...
public class HeapPage implements Page {
    ...
    public HeapPage getBeforeImage() {
        try {
            ...
            return new HeapPage(pid, oldDataRef);//有线程安全问题吧？
        } catch (IOException e) {
            e.printStackTrace();
...
//            throw new DbException("No find tuple");
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        if (t.getRecordId()!=null && t.getRecordId().getPageId() == pid) {
    ...
    public boolean isSlotUsed(int i) {
        return ((header[i / 8] >> (i % 8)) & 0b0000_0001) == 1;
    }
    ...
    private void markSlotUsed(int i, boolean value) {
        if (value) {
            header[i / 8] = (byte) (header[i / 8] | 0x1 << (i % 8));
        } else {
            header[i / 8] = (byte) (header[i / 8] ^ 0x1 << (i % 8));
        }
    }
    ...
    public Iterator<Tuple> iterator() {
        return new Iterator<Tuple>() {
            ...
            @Override
            public void remove() {
                throw new UnsupportedOperationException("Unrealized remove()");
            }
        };
    }
